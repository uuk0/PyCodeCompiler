...
PyObjectContainer* test_0(void) {
    ...
    obj_1 = PY_STD_list_CONSTRUCT_COMPREHENSION_on_list(obj_1, comprehension_transfer_8, NULL, NULL);
    ...
    obj_1 = PY_STD_list_CONSTRUCT_COMPREHENSION_on_list(obj_1, comprehension_transfer_10, NULL, (PyObjectContainer*[]) { t_2 });
