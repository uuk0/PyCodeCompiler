...
PyObjectContainer* testbasic_1(PyObjectContainer* self_0) {
    ...
    PY_CHECK_EXCEPTION(PY_invokeBoxedMethod(PY_getObjectAttributeByNameOrStatic_ThrowOnNull(self_0, "assertTrue"), NULL, 1, &temporary_2, NULL));

    PyObjectContainer* temporary_3 = PY_FALSE;
    PY_CHECK_EXCEPTION(PY_invokeBoxedMethod(PY_getObjectAttributeByNameOrStatic_ThrowOnNull(self_0, "assertFalse"), NULL, 1, &temporary_3, NULL));

    PY_CHECK_EXCEPTION(PY_invokeBoxedMethod(PY_getObjectAttributeByNameOrStatic_ThrowOnNull(self_0, "assertEqual"), NULL, 2, (PyObjectContainer*[]) {PY_createInteger(10), PY_createInteger(10)}, NULL));

    PY_CHECK_EXCEPTION(PY_invokeBoxedMethod(PY_getObjectAttributeByNameOrStatic_ThrowOnNull(self_0, "assertNotEqual"), NULL, 2, (PyObjectContainer*[]) {PY_createInteger(10), PY_createInteger(20)}, NULL));
