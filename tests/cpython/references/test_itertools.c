...
PyObjectContainer* PY_MODULE_test_itertools_init(void) {
    ...
    function_container_test_chain_empty_0 = PY_createBoxForFunction(testchainempty_1_safeWrap);
    function_container_test_chain_rhs_empty_1 = PY_createBoxForFunction(testchainrhsempty_3_safeWrap);
    function_container_test_chain_basic_2 = PY_createBoxForFunction(testchainbasic_5_safeWrap);
...
PyObjectContainer* testchainempty_1(PyObjectContainer* self_0) {
    ...
    PY_CHECK_EXCEPTION(PY_STD_list_init_fast_arg_1(obj_instance_5 , PY_CHECK_EXCEPTION(PY_invokeBoxedMethod(PY_getObjectAttributeByNameOrStatic_ThrowOnNull(PY_MODULE_INSTANCE_itertools, "chain"), NULL, 2, (PyObjectContainer*[]) {PY_STD_list_CREATE(0), PY_STD_list_CREATE(0)}, NULL))));

    PY_CHECK_EXCEPTION(PY_invokeBoxedMethod(PY_getObjectAttributeByNameOrStatic_ThrowOnNull(self_0, "assertEqual"), NULL, 2, (PyObjectContainer*[]) {obj_instance_5, PY_STD_list_CREATE(0)}, NULL));
...
PyObjectContainer* testchainrhsempty_3(PyObjectContainer* self_2) {
    ...
    PY_CHECK_EXCEPTION(PY_STD_list_init_fast_arg_1(obj_instance_9 , PY_CHECK_EXCEPTION(PY_invokeBoxedMethod(PY_getObjectAttributeByNameOrStatic_ThrowOnNull(PY_MODULE_INSTANCE_itertools, "chain"), NULL, 2, (PyObjectContainer*[]) {PY_STD_list_CREATE(1, PY_createString("test")), PY_STD_list_CREATE(0)}, NULL))));

    PY_CHECK_EXCEPTION(PY_invokeBoxedMethod(PY_getObjectAttributeByNameOrStatic_ThrowOnNull(self_2, "assertEqual"), NULL, 2, (PyObjectContainer*[]) {obj_instance_9, PY_STD_list_CREATE(1, PY_createString("test"))}, NULL));
...
PyObjectContainer* testchainbasic_5(PyObjectContainer* self_4) {
    ...
    PY_CHECK_EXCEPTION(PY_STD_list_init_fast_arg_1(obj_instance_13 , PY_CHECK_EXCEPTION(PY_invokeBoxedMethod(PY_getObjectAttributeByNameOrStatic_ThrowOnNull(PY_MODULE_INSTANCE_itertools, "chain"), NULL, 2, (PyObjectContainer*[]) {PY_STD_list_CREATE(1, PY_createString("test")), PY_STD_list_CREATE(1, PY_createInteger(2))}, NULL))));

    PY_CHECK_EXCEPTION(PY_invokeBoxedMethod(PY_getObjectAttributeByNameOrStatic_ThrowOnNull(self_4, "assertEqual"), NULL, 2, (PyObjectContainer*[]) {obj_instance_13, PY_STD_list_CREATE(2, PY_createString("test"), PY_createInteger(2))}, NULL));
