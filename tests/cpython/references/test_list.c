...
PyObjectContainer* PY_CLASS_INIT_PY_CLASS_ListTest_8(PyClassContainer** cls) {
    // Create Class PY_CLASS_ListTest_8 ('ListTest' in source code)
    *cls = PY_createClassContainer("ListTest");
    ...
    PY_setClassAttributeByNameOrCreate(*cls, "test_truth", PY_createBoxForFunction(testtruth_3_safeWrap));
    PY_setClassAttributeByNameOrCreate(*cls, "test_identity", PY_createBoxForFunction(testidentity_5_safeWrap));
    PY_setClassAttributeByNameOrCreate(*cls, "test_len", PY_createBoxForFunction(testlen_7_safeWrap));
...
PyObjectContainer* testbasic_1(PyObjectContainer* self_0) {
    ...
    PyObjectContainer* l0_3_10;
    PyObjectContainer* l0_3_bis_11;
    ...
    PY_CHECK_EXCEPTION(PY_STD_list_init_fast_arg_1(obj_instance_8 , l0_3_10));
